...
FomoClient.prototype = (function () {
    ...
    return {
        ...
        createEvent: function (event, callback) {
            makeRequest(this.endpoint, '/api/v1/applications/me/events', 'POST', this.authToken, callback, event);
        },
        ...
        updateEvent: function (event, callback) {
            makeRequest(this.endpoint, '/api/v1/applications/me/events/' + event.id, 'PATCH', this.authToken, callback, event);
        },
